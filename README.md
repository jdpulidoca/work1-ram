# ELECTRÓNICA DIGITAL 1 UNIVERSIDAD NACIONAL DE COLOMBIA 


## TRABAJO 01- EVALUACIÓN DE MEMORIA  MAXOMA 
...
WP01 Semana 1: Buffer de memoria  Simulación (TestBench).  Analizar la máxima memoria ram que podemos alojar en la FPGA,  y planear el método de adquisición de los datos de la cámara 
WP02 Semana 2: Captura de datos Construcción del bloque de captura de datos y divisor de frecuencias según hoja de datos de la cámara.
Semana 3: Captura de datos Pruebas físicas con cámara 
WP03 Semana 4: Introducción al procesador *
WP04 Semana 5: Comunicación serial, gpio 
WP05 Semana 6: Integración del proyecto y pruebas funcionales
